...
export default buildConfig({
  ...
  admin: {
    // user: Usuarios.slug, // Temporarily disabled to debug collection initialization errors
    meta: {
  ...
  db: postgresAdapter({
    ...
    push: false, // Disabled temporarily - schema inconsistencies. Use /api/sync-schema manually
  }),
